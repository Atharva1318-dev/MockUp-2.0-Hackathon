        ...
        <div className="overflow-hidden">
          ...
          >
            {products.map((product) => (
              <div
                key={product.id}
                className="w-1/4 bg-[#333333] rounded-3xl p-10 flex flex-col items-center transition-all duration-300"
              >
                ...
                <div className="h-[140px] flex flex-col items-center justify-between">
                  <h3 className="text-lg font-semibold text-white text-center">{product.name}</h3>
